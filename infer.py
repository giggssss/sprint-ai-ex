...
def run_inference(args):
    ...
    print("=" * 60)
    print(f"🔍 YOLO 추론 시작: {args.weights}")
...
def main():
    ...
    parser.add_argument("--weights", type=str, default="yolo11n.pt", help="Path to trained model weights (.pt)")
    parser.add_argument("--source", type=str, default="/Volumes/Macintosh SUB/Dataset/yolo_data/val/images", help="Image file or directory path")
