...
def main():
    print("Loading SimCLR-pretrained YOLO model...")
    # Load the model with SSL-pretrained backbone
    model = YOLO('models/simclr_best.pt')
    ...
    model.train(
        ...
        epochs=30, # 30 epochs is usually enough for fine-tuning a pre-trained model
        batch=16,
        imgsz=640,
        project='runs/detect',
        name='train_yolo_finetune_ssl',
